...
|-----|--------|------------|-------------------|----------------|
| [Lab 01](lab-01-reconnaissance.md) | Reconocimiento de Red | Basica | 2-3 horas | Nmap, descubrimiento de red, enumeracion de servicios |
| [Lab 02](lab-02-exploitation-web.md) | Explotacion Web (OWASP Top 10) | Media | 4-5 horas | SQLi, XSS, Command Injection, LFI, File Upload |
