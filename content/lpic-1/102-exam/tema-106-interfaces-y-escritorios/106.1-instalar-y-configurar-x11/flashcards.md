...
**P:** Que hace el comando `(WW)`?

</div>
<div class="flashcard-back">

**R:** Advertencia (Warning)
...
**R:** 1. **X11** usa arquitectura cliente-servidor: el servidor esta donde esta la pantalla
