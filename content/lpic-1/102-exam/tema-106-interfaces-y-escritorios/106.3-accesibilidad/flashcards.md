...
> 3 tarjetas de repaso. Usa el sistema de repeticion espaciada para memorizar.
...
**R:** 1. **Orca** es el lector de pantalla principal de GNOME (usa AT-SPI y Speech Dispatcher)
